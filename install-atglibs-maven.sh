...
mvn install:install-file \
  ...
  -Dpackaging=jar \
  -Dversion=${ATG_VERSION} \
  -Dfile=${DYNAMO_ROOT}/DAF/Endeca/Assembler/lib/endeca_assembler_core.jar
...
mvn install:install-file \
  ...
  -Dpackaging=jar \
  -Dversion=${ATG_VERSION} \
  -Dfile=${DYNAMO_ROOT}/DAF/Endeca/Assembler/lib/endeca_assembler_navigation.jar
...
mvn install:install-file \
  ...
  -Dpackaging=jar \
  -Dversion=${ATG_VERSION} \
  -Dfile=${DYNAMO_ROOT}/DAF/Endeca/Assembler/lib/endeca_navigation.jar